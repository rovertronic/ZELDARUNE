...
DEFINE_SEQUENCE(Sequence_MyAudioStream, NA_BGM_MYAUDIOSTREAM, MEDIUM_CART, CACHE_LOAD_PERSISTENT, SEQ_FLAG_ENEMY)
DEFINE_SEQUENCE(Sequence_MyAudioStream2, NA_BGM_MYAUDIOSTREAM2, MEDIUM_CART, CACHE_LOAD_PERSISTENT, SEQ_FLAG_ENEMY)
DEFINE_SEQUENCE(Sequence_MyAudioStream3, NA_BGM_MYAUDIOSTREAM3, MEDIUM_CART, CACHE_LOAD_PERSISTENT, SEQ_FLAG_ENEMY)