...
DEFINE_ACTOR(Destructible_Bookshelves, ACTOR_DESTRUCTIBLE_BOOKSHELVES, ACTOROVL_ALLOC_NORMAL, "Destructible_Bookshelves")
DEFINE_ACTOR(Titan, ACTOR_TITAN, ACTOROVL_ALLOC_NORMAL, "Titan")
DEFINE_ACTOR(Darkbubble, ACTOR_DARKBUBBLE, ACTOROVL_ALLOC_NORMAL, "Darkbubble")
DEFINE_ACTOR(Darkbubbleemitter, ACTOR_DARKBUBBLEEMITTER, ACTOROVL_ALLOC_NORMAL, "Darkbubbleemitter")
DEFINE_ACTOR(Redeye, ACTOR_REDEYE, ACTOROVL_ALLOC_NORMAL, "Redeye")
DEFINE_ACTOR(OLDMAN, ACTOR_OLDMAN, ACTOROVL_ALLOC_NORMAL, "OLDMAN")