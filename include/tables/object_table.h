...
DEFINE_OBJECT(object_destructible_bookshelves, OBJECT_DESTRUCTIBLE_BOOKSHELVES)
DEFINE_OBJECT(object_titan, OBJECT_TITAN)
DEFINE_OBJECT(object_darkbubble, OBJECT_DARKBUBBLE)
DEFINE_OBJECT(object_redeye, OBJECT_REDEYE)