...
MSG(
QUICKTEXT_ENABLE
COLOR(LIGHTBLUE) "Finish it off with an\n\
arrow of " COLOR(YELLOW) "LIGHT!"
)
,
MSG(/* MISSING */)
,
...
,
MSG(
QUICKTEXT_ENABLE "What're y'all\n\
givin' up for?"
),
MSG(/* MISSING */)
,
...
,
MSG(
"Don't..." BOX_BREAK_DELAYED(20) EVENT
)
,
MSG(/* MISSING */)
,
...
MSG(
"DON'T MAKE ANOTHER\n\
FOUNTAIN!!!" BOX_BREAK_DELAYED(30) EVENT
)
,
MSG(/* MISSING */)
,
